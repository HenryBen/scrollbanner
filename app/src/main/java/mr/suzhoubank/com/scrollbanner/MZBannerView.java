...
import mr.suzhoubank.com.scrollbanner.transformer.CoverModeTransformer;
import mr.suzhoubank.com.scrollbanner.transformer.ScaleYTransformer;
...
//                holder.onBind(container.getContext(),realPosition,mDatas.get(realPosition));
                holder.onBind(container.getContext(),realPosition,mDatas);
            }
